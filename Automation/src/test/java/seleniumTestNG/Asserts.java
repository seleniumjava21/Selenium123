...
public class Asserts {
	...
	public void AutoIT() throws Throwable {
		...
		String title2 = "Sign in – Google accounts";
		
		String title1 = "hfjdgh";
		
		//if(drv.getTitle().contentEquals("Sign in – Google accounts"));
		
		//Assert.assertEquals(title2, title);//equal-true-pass
		
	//	Assert.assertEquals(title1, title);//not equal-false-fail.
		
		Assert.assertEquals(drv.getTitle(), title ,"expected title is not same as actual");
